...
from src.model import create_tl_model
...
if __name__ == "__main__":
    ...
    model = create_tl_model(NUM_CLASSES).to(device)
    loss_func = nn.CrossEntropyLoss()
    opt = Adam(params=model.fc.parameters(), weight_decay=0.001, lr=0.001)
    ...
    train(
        ...
        save_path="models/save_tl_models", EPOCHS=100
    )
